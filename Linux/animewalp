...
def Main():
    ...
    parser.add_argument("-n", "--get_new", action = "store_true", help = "get new wallpaper and apply as desktop background")
    parser.add_argument("-g", "--get", action = "store_true", help = "get a hot anime girl, without applying as desktop background")
